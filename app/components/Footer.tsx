...
export default function Footer() {
  return (
    <footer className="bg-[#062340] border-t border-white/10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="mt-4 bg-[#28529C] rounded-lg p-3">
        ...
        <div className="border-t border-white/10 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © 2025 JustDit.id. All rights reserved.
            </p>
            <div className="flex items-center gap-4 text-sm text-gray-400">
              <span>Payment Methods:</span>
              <div className="flex gap-2">
                <span className="bg-white/10 px-3 py-1 rounded">BCA</span>
                <span className="bg-white/10 px-3 py-1 rounded">GoPay</span>
                <span className="bg-white/10 px-3 py-1 rounded">QRIS</span>
              </div>
            </div>
          </div>
        </div>
